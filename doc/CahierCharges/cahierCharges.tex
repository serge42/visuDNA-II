...
\newcommand{\docVersion}{Version 1.0 - 19.12.2017}
...
\begin{ganttchart}[
  ...
  \ganttbar[progress=100, inline=false]{Cahier des charges}{2017-09-27}{2017-10-18}\\
  \ganttmilestone[inline=false]{D1: rendu cahier}{2017-10-18} \\
  %Etat de l'art
  \ganttgroup[inline=false]{État de l'art}{2017-10-01}{2017-10-18} \\
  \ganttbar[progress=100,inline=false]{Review ancien projet}{2017-10-01}{2017-10-08} \\
  \ganttbar[progress=100,inline=false]{Recherche d'outils}{2017-10-08}{2017-10-12}\\
  \ganttlinkedbar[progress=90,inline=false]{Comparaison outils}{2017-10-12}{2017-10-18}\\
  ...
  \ganttmilestone[inline=false]{D2: diagramme classe}{2017-11-24} \\
  ...
  \ganttmilestone[inline=false]{D3: power point}{2017-11-08} \\

  %IMPLEMENTATION
  \ganttgroup[inline=false]{Implémentation}{2017-11-23}{2018-01-14} \\
  \ganttbar[inline=false,progress=0]{Créer graphe augmenté}{2017-11-23}{2017-12-1}\\
  \ganttbar[inline=false,progress=0]{Intégrer visualisation}{2017-12-1}{2017-12-14}\\
  \ganttbar[inline=false,progress=0]{Lay-outs et filtres}{2017-12-14}{2017-12-19}\\
  \ganttbar[inline=false,progress=0]{Annotations}{2017-12-20}{2017-12-24}\\
  \ganttbar[inline=false,progress=0]{Export des graphes}{2018-1-8}{2018-1-10}\\
  \ganttmilestone[inline=false]{M2: prototype fonctionnel}{2017-12-18}\\

  %TESTS
  \ganttgroup[inline=false]{Tests}{2017-12-11}{2018-02-01} \\
  \ganttbar[inline=false,progress=0]{Unitaires}{2017-12-11}{2017-12-23}
  \ganttlinkedbar[progress=0]{}{2018-1-8}{2018-1-18}\\
  \ganttbar[inline=false,progress=0]{fonctionnels}{2018-01-12}{2018-02-01} \\
  \ganttmilestone[inline=false]{D4: application finale}{2018-2-1}\\

  %RAPPORT
  \ganttgroup[inline=false]{Documentation}{2017-10-5}{2018-02-01}\\
  \ganttbar[progress=100,inline=false]{UC général}{2017-10-05}{2017-10-15}\\
  \ganttbar[inline=false,progress=90]{Choix de l'outil}{2017-10-20}{2017-10-26}\\
  \ganttlinkedbar[inline=false,progress=0]{Diagramme classe}{2017-11-20}{2017-11-30} \\
  \ganttbar[inline=false,progress=0]{Tests}{2018-1-21}{2018-2-1} \\
  \ganttbar[inline=false,progress=0]{D6: mode d'emploi}{2018-1-8}{2018-2-1}\\
  \ganttmilestone[inline=false]{D5: rapport final}{2018-02-01} \\

  \ganttgroup[inline=false]{Défense}{2018-02-02}{2018-02-07}\\
  \ganttbar[inline=false,progress=0]{Préparation}{2018-02-02}{2018-02-07}\\
  \ganttmilestone[inline=false]{D6: défense}{2018-02-08} \\
  ...
  % shading
  \begin{scope}
    \draw[opacity=.7,line width=6.3mm](holiday-october-top) -- ($(holiday-october-bottom)+(0,-5pt)$);
    ...
    \draw[opacity=.7,line width=13.5mm](holiday-december-top) -- ($(holiday-december-bottom)+(0,-5pt)$);
  \end{scope}
\end{ganttchart} \\
